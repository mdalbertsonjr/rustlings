...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        if let Some(team_1_value) = scores.get(&team_1_name) {
        ...
        if let Some(team_2_value) = scores.get(&team_2_name) {
            scores.insert(team_2_name, Team {
                goals_scored : team_2_value.goals_scored + team_2_score,
                goals_conceded : team_2_value.goals_conceded + team_1_score,
            });
        } else {
            scores.insert(team_2_name, Team {
